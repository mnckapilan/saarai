      ...
      <div className={styles.content}>
        <header className={styles.header}>
          ...
          <div>
            ...
            <p className={styles.nameOrigin}>Named after <em>saarai paambu</em> (சாரைப்பாம்பு) — the Tamil name for the Indian rat snake (<em>Ptyas mucosa</em>), keeping with the Python theme</p>
          </div>
        </header>
